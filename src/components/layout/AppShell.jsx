...
export default function AppShell({ sidebar, children, maxWidth = 900 }) {
  return (
    <div className="app-shell" style={{ display: "flex", minHeight: "100svh", width: "100%", background: CREAM, fontFamily: SANS, color: INK, overflowX: "clip" }}>
      <div className="app-shell__sidebar">{sidebar}</div>
      <div className="app-shell__main" style={{ flex: 1, minWidth: 0 }}>
