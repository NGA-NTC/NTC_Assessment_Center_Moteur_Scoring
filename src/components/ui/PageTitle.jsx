...
export default function PageTitle({ title, subtitle, right, action }) {
  ...
  return (
    <div className="page-title" style={{ marginBottom: 18, display: "flex", alignItems: "flex-end", gap: 10, flexWrap: "wrap", justifyContent: "space-between", width: "100%" }}>
      ...
      {actions && <div className="page-title__actions" style={{ flexShrink: 0, minWidth: 0, maxWidth: "100%" }}>{actions}</div>}
    </div>
  );
}